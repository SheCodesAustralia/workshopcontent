  ...
  <form method="POST" action="https://shecodes.activehosted.com/proc.php" id="_form_32_" class="_form _form_32 _inline-form _inline-style _dark" novalidate data-styles-version="5">
    ...
    <div class="_form-content">
      ...
      <div class="_button-wrapper _inline-style">
        <input id="_form_32_submit" class="_submit" type="button"  value="Download" >
        </input>
      </div>
...
document.getElementById("_form_32_submit").addEventListener('click', function(){
...
image.src = "../images/wordpress_certificate.png";
